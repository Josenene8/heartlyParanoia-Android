...
class OutdatedSubState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var txt:FlxText = new FlxText(0, 0, FlxG.width,
			"Thanks for downloading Heartly Paranoia!\nThe character in this mod is from Touhou Project" 
			+ "\n(Own by Team Shanghai Alice)"
			+ "\nThere is going to be more content in the future so stay tuned!"
			+ "\nAll feedback is welcome and please enjoy the mod."
			+ "\n"
			+ "\nPS. Reocommended play with downscroll",32);
