...
class Character extends FlxSprite
{
	...
	public var iconColor:String = "FF41FAB0";
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'bf':
				...
				case 'bfWeird':
				iconColor = "FF2AE8DB";
				var tex = Paths.getSparrowAtlas('bfWeird','shared',true);
				frames = tex;
			...
			case 'koishi':
				// DAD ANIMATION LOADING CODE
				iconColor = "FF823A9C";
				tex = Paths.getSparrowAtlas('koishiAssets','shared',true);
				frames = tex;
				animation.addByPrefix('idle', 'koishi Idle Dance', 24, false);
				animation.addByPrefix('singUP', 'koishi Up note', 24, false);
				animation.addByPrefix('singRIGHT', 'koishi NOTE LEFT', 24, false);
				animation.addByPrefix('singDOWN', 'koishi Down Note', 24, false);
				animation.addByPrefix('singLEFT', 'koishi Note Right', 24, false);
				animation.addByPrefix('angery', 'koishi Angery', 24, false);
			...
			case 'mary':
				// DAD ANIMATION LOADING CODE
				iconColor = "FF823A9C";
				tex = Paths.getSparrowAtlas('mary','shared',true);
				frames = tex;
				animation.addByPrefix('idle', 'koishi Idle Dance', 24, false);
				animation.addByPrefix('singUP', 'koishi Up note', 24, false);
				animation.addByPrefix('singRIGHT', 'koishi NOTE LEFT', 24, false);
			...
			case 'lmao':
				// DAD ANIMATION LOADING CODE
				iconColor = "FFFA3840";
				tex = Paths.getSparrowAtlas('lmao','shared',true);
				frames = tex;
				animation.addByPrefix('idle', 'fumo idle', 24, false);
