...
class Note extends FlxSprite
{
	...
	public var noteVar:String = "normal";
	...
	public function new(strumTime:Float, noteData:Int, ?prevNote:Note, ?sustainNote:Bool = false, ?inCharter:Bool = false, noteVar:String = "normal")
	{
		super();
